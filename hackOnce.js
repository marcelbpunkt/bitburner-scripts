/**
 * Hacks a specified target server once. The number of threads must be
 ...
 * is to be hacked (mandatory). The second argument is the time to
 * wait before hacking the target in milliseconds (optional).
 * 
